 ...
 */
function understrap_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'understrap_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.understrap-front-page) .entry-title,
...
.colors-custom .understrap-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.understrap-front-page .panel-content .recent-posts article,
...
.colors-custom.understrap-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'understrap_custom_colors_css', $css, $hue, $saturation );
}
