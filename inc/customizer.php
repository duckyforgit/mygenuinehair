...
function foundationpress_customize_register2( $wp_customize ) {

// $wp_customize->add_panel( 'banner',
//     array(
//         'title'      => esc_html__( 'Banner Hero', 'foundationpress' ),
//         'priority'   => 20,
//         'capability' => 'edit_theme_options',
//         'description' => __( 'Banner Panel', 'foundationpress' ),
//     )
// );
//    $wp_customize->add_section( 'banner_hero', array(
//     'title'          => __( 'Banner Hero' ),
//     'description'    => __( 'Banner Settings' ),
//     'panel'          => 'banner', // Not typically needed.
//     'priority'       => 160,
//     'capability'     => 'edit_theme_options',
//     'theme_supports' => '', // Rarely needed.
// ) );
//  $wp_customize->add_field( 'foundationpress_theme', array(
//   'type'     => 'text',
//   'settings' => 'hero_text',
//   'label'    => __( 'Hero Text', 'foundationpress' ),
//   'section'  => 'banner_hero',
//   'default'  => esc_attr__( 'This is a default value', 'foundationpress' ),
//   'priority' => 10,
// ) );
// $wp_customize->add_field( 'foundationpress_theme', array(
//   'type'        => 'image',
//   'settings'    => 'hero_image',
//   'label'       => __( 'Hero Image', 'foundationpress' ),
//   'description' => __( 'This is the hero image upload', 'foundationpress' ),
//   'section'     => 'banner_hero',
//   'default'     => '',
//   'priority'    => 10,
// ) );
}
//add_action( 'customize_register', 'foundationpress_customize_register2' ); 
...
if ( ! function_exists( 'understrap_customize_preview_js' ) ) {
	...
	function understrap_customize_preview_js() {
		wp_enqueue_script(
			...
			get_template_directory_uri() . '/inc/customize-preview.js',
