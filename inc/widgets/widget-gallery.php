...
if ( ! class_exists( 'Understrap_Widget_Gallery' ) ) {

    class Understrap_Widget_Gallery extends WP_Widget {
  /**
   * Widget Constructor
   *
  ...
  public function __construct() {
    ...
    parent::__construct(
      'example',  
      esc_html__( 'Understrap Widget Gallery', 'understrap' ),  
      array(
        'classname' => 'understrap-widget-gallery',
        'description' => esc_html__( 'Displays Gallery of Posts in On Focus area of Home Page.', 'understrap' ),
  ...
  public function delete_widget_cache() {
    ...
    wp_cache_delete( 'understrap-widget-gallery', 'widget' );
  ...
  public function widget( $args, $instance ) {
   ...
   if ( ! $this->is_preview() ) {
     $cache = wp_cache_get( 'understrap-widget-gallery', 'widget' );
    }
    if ( ! is_array( $cache ) ) {
      $cache = array();
   }
...
?>
      <ol class="understrap-widget-gallery">
    ...
    if ( ! $this->is_preview() ) {
      ...
      wp_cache_set( 'understrap-widget-gallery', $cache, 'widget' );
    } else {
      ob_end_flush();
    }
...
<?php /* removed rows="16" cols="20" */ ?>
    <p>
      <label for="<?php echo $this->get_field_id( 'widget_title' ); ?>"><?php esc_html_e( 'Title:', 'understrap' ); ?>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('Example_1'); ?>"><?php esc_html_e('Enter line 1', 'understrap'); ?></label> 
    ...
    <p>
      <label for="<?php echo $this->get_field_id('Example_2'); ?>"><?php esc_html_e('Enter line 1', 'understrap'); ?></label> 
    ...
    <p>
      <label for="<?php echo $this->get_field_id('Example_3'); ?>"><?php esc_html_e('Enter line 1', 'understrap'); ?></label> 
