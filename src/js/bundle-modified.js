...
// });
 ...
 let width = box[0].offsetWidth + 130;
 ...
 container.addEventListener('dragend', slideShowNew);
 function slideShowNew() {
    if(change > 0) {
        let ct = container.scrollLeft += width;
        console.log(ct);
    } else {
        let cb = container.scrollLeft -= width;
        console.log(cb);
    }
 } 
...
let checkbox = document.querySelectorAll("input[type='checkbox']");
   ...
   if (btn) {
    ...
    // id="<?php //echo $qid;?>"
        ...
        let q11 = document.getElementById('q_1_1').value;
        let q12 = document.getElementById('q_1_2').value;
        let q13 = document.getElementById('q_1_3').value;
        let question2 = document.getElementById('2').value;
        let q21 = document.getElementById('q_2_1').value;
        let q22 = document.getElementById('q_2_2').value;
        let q23 = document.getElementById('q_2_3').value;
      ...
      //  preloader.classList.add('d-block');
       ...
       // console.log(nonceValue);
        ...
        let apiUrl = siteObj.siteUrl + '/wp-json/understrap/v1/rest05';
