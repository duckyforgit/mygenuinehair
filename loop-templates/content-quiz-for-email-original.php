...
<div class="container d-flex align-items-center ">
   <div class="row g-0 justify-content-center">
    ...
    <form autocomplete="off" class="needs-validation flex-column" id="form-wrapper" method="post" name="form-wrapper" novalidate action="">
        <fieldset>
            <legend>Fill out to take the quiz</legend>quu
        </fieldset>
            ...
            while( have_rows('quiz_question_group') ) : the_row();
                $questions = get_sub_field('quiz_question', $id );
                 foreach( $questions as $question ):  
                  echo get_the_title($question->ID);
                $ans = 0; ?>
                <div class="">
                  <?php $ques ++; ?>
                    ...
                    <!-- q_5_two  -->
                           <div class="form-check ps-0 q-box"> 
                              <div class="q-box__question">
                                ...
                                <label class="form-check-label question__label" for="<?php echo $qid; ?>"><?php //echo $answer_text[0];?>
                                </label>
                             </div>
                           </div>
