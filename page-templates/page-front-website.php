<?php
/**
 * Template Name: Page Front Website after Launch
 *
  ...
  <div class="row gx-5 justify-content-between align-items-center">
      ...
      <div class="col-sm-12 col-lg-7 col-xl-6 relative ">
        ...
        <iframe>Insert video here </iframe>
          <!-- <iframe loading="lazy" title="Botanika Beauty FULL Line Review" width="100%" height="100%" 
          src="https://www.youtube.com/embed/qmASSbwity4?feature=oembed" frameborder="0" 
  ...
  <div class="row gx-5 justify-content-between align-items-center">
    ...
    <div class="col-12 col-lg-6 background-gh">
      ...
      <h2 class="h4 raleway">We created the an all natural <span class="hair-type" style="display: block;"><strong>personalized haircare</strong> line for each hair type!</span></h2>
       <div class="spacer-16"></div>
      <p>We alleviate the burden of choosing the right product for your specific type of hair. Join a free hair research trial to get a truly customized product.</p>
      <div class="spacer-16"></div>
      <a class="btn btn-outline-dark btn-lg fw-bolder" href="">Join our Hair Research</a>
     </div>
...
<section class="section-wrapper container relative">
  ...
  <div class="row gx-5 justify-content-between align-items-center">
    ...
    <div class="col-sm-12 col-lg-6"> 
      ...
      <div class="spacer-16"></div>
      <a class="btn btn-outline-dark btn-lg fw-bolder" href="">Shop our organic products </a>  
     </div>
     <div class="col-sm-12 col-lg-6">
...
<section class="section-wrapper container-fluid background-gradient">
  ...
  <div class="container">
    ...
    <h2 class="">Take our Hair Quiz</h2>
    <p>Find out what type of hair you have to determine <br> the personalized products that will create your "Good Hair". 
    </div>
    <div class="col-sm-12 col-lg-4">
    <!-- <img src="<?php echo get_template_directory_uri().'/dist/img/stock-photo-side-view-of-positive-african-american-female-model-smiling-for-camera-and-touching-clean-curly-1738147088-transparent.png'; ?>" alt="" > -->
          <a href="#" class="btn btn-outline-light btn-light btn-lg text-white" style="background-color:transparent">Start the Quiz</a>
    </div>
    </div>
  </div>
</section>
