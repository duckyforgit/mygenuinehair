...
function gs_testimonial_help_menu() {
	...
	add_submenu_page( 
	    ...
	    'manage_options', 
	    'gs-testimonial-help', 
	    'gstestimonial_help_menu_cb'
	);
}

add_action('admin_menu', 'gs_testimonial_help_menu');

function gstestimonial_help_menu_cb() {
	?>

    <div class="gs-wrap">
        
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 50px; text-align: center;">
	        <h1>GS Testimonial Slider by GS Plugins</h1>
			<div class="help-link">
    			<a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsplugins.com/product/gs-testimonial-slider" target="_blank">Plugin Home</a>
    			<a class="gstm-hlp-btn gstm-btn-2" href="http://testimonial.gsplugins.com" target="_blank">Live Demo</a>
    			<a class="gstm-hlp-btn gstm-btn-3" href="http://testimonial.gsplugins.com/documentation" target="_blank">Documentation</a>
    			<a class="gstm-hlp-btn gstm-btn-4" href="http://testimonial.gsplugins.com/documentation/#GS_Testimonial_Slider8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
            ...
            <iframe width="825" height="480" src="https://www.youtube.com/embed/eV39_xaYFu4?rel=0" frameborder="0" allowfullscreen></iframe>
        </div>
