        ...
        $settings_fields = array(
            ...
            'gs_t_advance' => array(
                ...
                array(
                    ...
                    'options'   => array(
                        'none'     => 'None',
                        'gs_style1'    => 'Style 1 (Free)',
                        'gs_style2'    => 'Style 2 (Free)',
                        'gs_style3'    => 'Style 3 (Free)',
                        'gs_style4'    => 'Style 4 (Free)',
                        'gs_style8'    => 'Style 8 (Free)',
            ...
            <div class="gswps-admin-sidebar" style="width: 277px; float: left; margin-top: 50px;">
                <div class="postbox">
                    ...
                    <div class="inside centered">
                        ...
                        <p><a href="https://www.gsplugins.com/support" target="_blank" class="button button-primary">Get Support</a></p>
                    </div>
                </div>
                <div class="postbox">
